...
public class InstrumentedType0 extends TypeDescription.AbstractTypeDescription implements TypeDescription, NamingStrategy.UnnamedType {
    ...
    public InstrumentedType0(ClassVersion classVersion,
                             Class<?> superClass,
