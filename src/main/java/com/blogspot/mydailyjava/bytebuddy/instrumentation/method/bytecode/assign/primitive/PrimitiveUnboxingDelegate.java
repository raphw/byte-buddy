...
public enum PrimitiveUnboxingDelegate implements Assignment {
    ...
    public static interface UnboxingResponsible {
        ...
        Assignment assignUnboxedTo(TypeDescription subType, Assigner assigner, boolean considerRuntimeType);
    }
    ...
    private static enum ExplicitlyTypedUnboxingResponsible implements UnboxingResponsible {
        ...
        @Override
        public Assignment assignUnboxedTo(TypeDescription subType, Assigner assigner, boolean considerRuntimeType) {
