package com.blogspot.mydailyjava.old.score;

import com.blogspot.mydailyjava.old.method.score.AnnotationMethodScorer;
import com.blogspot.mydailyjava.old.method.score.MethodScorer;
import com.blogspot.mydailyjava.old.method.stack.AllArgumentsReference;
import com.blogspot.mydailyjava.old.method.stack.ClassIdReference;
import com.blogspot.mydailyjava.old.method.stack.InstanceIdReference;
import com.blogspot.mydailyjava.old.method.stack.ThisReference;
import com.blogspot.mydailyjava.old.sample.method.statics.*;
import com.blogspot.mydailyjava.old.sample.method.statics.annotated.P0_void_AllArguments;
import com.blogspot.mydailyjava.old.sample.method.statics.annotated.P0_void_ClassId;
import com.blogspot.mydailyjava.old.sample.method.statics.annotated.P0_void_InstanceId;
import com.blogspot.mydailyjava.old.sample.method.statics.annotated.P0_void_ThisReference;
import com.blogspot.mydailyjava.old.type.ClassLoadingCompatibilityEvaluator;
...
public class AnnotationMethodScorerTest {
    ...
    public void test_P0_void() throws Exception {
        ...
        MethodScorer.MatchedMethod matchedMethod = methodScorer.match(targetMethod);
        assertEquals(0, matchedMethod.getValues().size());
    }

    @Test(expected = MethodScorer.NoMatchException.class)
    public void test_P0_Object() throws Exception {
        Method targetMethod = P0_Object.class.getDeclaredMethod(METHOD_NAME);
        methodScorer.match(targetMethod);
    }
