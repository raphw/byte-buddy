...
public class PrimitiveTypeAwareAssignerTest {
    ...
    public void testUnboxing() throws Exception {
        ...
        assertThat(primitiveAssigner.assign(Byte.class, byte.class, false).isValid(), is(true));
        assertThat(primitiveAssigner.assign(Short.class, short.class, false).isValid(), is(true));
        assertThat(primitiveAssigner.assign(Character.class, char.class, false).isValid(), is(true));
        assertThat(primitiveAssigner.assign(Integer.class, int.class, false).isValid(), is(true));
        assertThat(primitiveAssigner.assign(Long.class, long.class, false).isValid(), is(true));
        assertThat(primitiveAssigner.assign(Float.class, float.class, false).isValid(), is(true));
        assertThat(primitiveAssigner.assign(Double.class, double.class, false).isValid(), is(true));
    ...
    public void testImplicitUnboxing() throws Exception {
        assertThat(primitiveAssigner.assign(Object.class, boolean.class, true).isValid(), is(true));
        verify(chainedAssigner).assign(Object.class, Boolean.class, true);
        verifyNoMoreInteractions(chainedAssigner);

        assertThat(primitiveAssigner.assign(Object.class, byte.class, true).isValid(), is(true));
        verify(chainedAssigner).assign(Object.class, Byte.class, true);
        verifyNoMoreInteractions(chainedAssigner);

        assertThat(primitiveAssigner.assign(Object.class, short.class, true).isValid(), is(true));
        verify(chainedAssigner).assign(Object.class, Short.class, true);
        verifyNoMoreInteractions(chainedAssigner);

        assertThat(primitiveAssigner.assign(Object.class, char.class, true).isValid(), is(true));
        verify(chainedAssigner).assign(Object.class, Character.class, true);
        verifyNoMoreInteractions(chainedAssigner);

        assertThat(primitiveAssigner.assign(Object.class, int.class, true).isValid(), is(true));
        verify(chainedAssigner).assign(Object.class, Integer.class, true);
        verifyNoMoreInteractions(chainedAssigner);

        assertThat(primitiveAssigner.assign(Object.class, long.class, true).isValid(), is(true));
        verify(chainedAssigner).assign(Object.class, Long.class, true);
        verifyNoMoreInteractions(chainedAssigner);

        assertThat(primitiveAssigner.assign(Object.class, float.class, true).isValid(), is(true));
        verify(chainedAssigner).assign(Object.class, Float.class, true);
        verifyNoMoreInteractions(chainedAssigner);

        assertThat(primitiveAssigner.assign(Object.class, double.class, true).isValid(), is(true));
    ...
    public void testDelegation() throws Exception {
        assertThat(primitiveAssigner.assign(Object.class, Object.class, false).isValid(), is(true));
