...
//        when(simpleMethod.getDescriptor()).thenReturn(Type.getMethodDescriptor(Type.VOID_TYPE, new Type[0]));
...
//        when(fromAbstractMethod.getDescriptor()).thenReturn(Type.getMethodDescriptor(Type.VOID_TYPE, new Type[0]));
...
//        when(toAbstractMethod.getDescriptor()).thenReturn(Type.getMethodDescriptor(Type.VOID_TYPE, new Type[0]));
...
//        assertThat(unloaded.getDescription(), is(FOO));
