...
public class FieldAccessorNonBeanTest extends AbstractInstrumentationTest {
    ...
    public void testExplicitNameSetter() throws Exception {
        DynamicType.Loaded<SampleSetter> loaded = instrument(SampleSetter.class, FieldAccessor.ofField(FOO));
    ...
    public void testExplicitNameGetter() throws Exception {
        DynamicType.Loaded<SampleGetter> loaded = instrument(SampleGetter.class, FieldAccessor.ofField(FOO));
