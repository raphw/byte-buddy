...
public class FieldAccessTest {
    ...
    public void testGetter() throws Exception {
        ...
        StackManipulation.Size size = getter.getter().apply(methodVisitor, instrumentationContext);
