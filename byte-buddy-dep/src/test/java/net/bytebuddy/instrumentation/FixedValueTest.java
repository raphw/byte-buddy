...
public class FixedValueTest extends AbstractInstrumentationTest {
    ...
    public void testTypeDescriptionConstantPool() throws Exception {
        Class<? extends Qux> qux = instrument(Qux.class, FixedValue.value(new TypeDescription.ForLoadedType(Object.class))).getLoaded();
    ...
    public void testMethodTypeConstantPool() throws Exception {
        Class<? extends Qux> qux = instrument(Qux.class, FixedValue.value(JavaInstance.MethodType.of(void.class, Object.class))).getLoaded();
        assertThat(qux.getDeclaredFields().length, is(0));
    ...
    public void testMethodTypeConstantPoolValue() throws Exception {
        Class<? extends Qux> qux = instrument(Qux.class, FixedValue.value(makeMethodType(void.class, Object.class))).getLoaded();
        assertThat(qux.getDeclaredFields().length, is(0));
        assertThat(qux.newInstance().bar(), is(makeMethodType(void.class, Object.class)));
    }
    ...
    public void testMethodHandleConstantPool() throws Exception {
        Class<? extends Qux> qux = instrument(Qux.class, FixedValue.value(JavaInstance.MethodHandle.of(Qux.class.getDeclaredMethod("bar")))).getLoaded();
        assertThat(qux.getDeclaredFields().length, is(0));
    ...
    public void testMethodHandleConstantPoolValue() throws Exception {
        Class<? extends Qux> qux = instrument(Qux.class, FixedValue.value(makeMethodHandle())).getLoaded();
        assertThat(qux.getDeclaredFields().length, is(0));
        assertThat(JavaInstance.MethodHandle.of(qux.newInstance().bar()), is(JavaInstance.MethodHandle.of(makeMethodHandle())));
    }
