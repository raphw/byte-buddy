...
//        Class<?> loaded = new RebaseDynamicTypeBuilder<Foo>(ClassFileVersion.forCurrentJavaVersion(),
...
//                new RebaseDynamicTypeBuilder.TargetHandler.ForRebaseInstrumentation(new MethodRebaseResolver.MethodNameTransformer.Suffixing()))
//                .make()
...
//                MethodAttributeAppender.NoOp.INSTANCE,
//                ClassFileLocator.ForClassLoader.ofClassPath(),
//                RebaseDynamicTypeBuilder.TargetHandler.ForRedefinitionInstrumentation.INSTANCE)
//                .make()
//                .load(getClass().getClassLoader(), ClassLoadingStrategy.Default.WRAPPER)
//                .getLoaded();
//        assertThat(loaded.getName(), is(FOOBAR));
...
//            }
//        }).apply();
//        ObjectPropertyAssertion.of(RebaseDynamicTypeBuilder.TargetHandler.Prepared.ForRebaseInstrumentation.class).refine(new ObjectPropertyAssertion.Refinement<DynamicType>() {
//            @Override
...
//            }
//        }).apply();
//        ObjectPropertyAssertion.of(RebaseDynamicTypeBuilder.TargetHandler.ForRedefinitionInstrumentation.class).apply();
//        ObjectPropertyAssertion.of(RebaseDynamicTypeBuilder.TargetHandler.ForRebaseInstrumentation.class).apply();
//        ObjectPropertyAssertion.of(RebaseDynamicTypeBuilder.TargetHandler.Prepared.ForRebaseInstrumentation.MethodRebaseDelegation.class).apply();
//        ObjectPropertyAssertion.of(RebaseDynamicTypeBuilder.TargetHandler.Prepared.ForRebaseInstrumentation.MethodRebaseDelegation.Factory.class).apply();
//    }
//
