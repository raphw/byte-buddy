...
public class AgentBuilderDefinitionHandlerTest {
    ...
    public void testRebase() throws Exception {
        ...
        assertThat(AgentBuilder.DefinitionHandler.Default.REBASE.builder(typeDescription, byteBuddy, classFileLocator, methodNameTransformer),
    ...
    public void testRedefine() throws Exception {
        ...
        assertThat(AgentBuilder.DefinitionHandler.Default.REDEFINE.builder(typeDescription, byteBuddy, classFileLocator, methodNameTransformer),
                is((DynamicType.Builder) dynamicTypeBuilder));
    ...
    public void testObjectProperties() throws Exception {
        ObjectPropertyAssertion.of(AgentBuilder.DefinitionHandler.Default.class).apply();
    }
}
