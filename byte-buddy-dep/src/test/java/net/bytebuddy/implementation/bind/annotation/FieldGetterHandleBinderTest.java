...
public class FieldGetterHandleBinderTest extends AbstractAnnotationBinderTest<FieldGetterHandle> {
    ...
    public FieldGetterHandleBinderTest() {
        super(FieldGetterHandle.class);
    }
    ...
    public void testIllegalParameter() throws Exception {
        ...
        FieldGetterHandle.Binder.INSTANCE.bind(annotationDescription,
                source,
                target,
    ...
    public void testLegalAssignment() throws Exception {
        ...
        when(target.getDeclaredAnnotations()).thenReturn(new AnnotationList.Empty());
        when(stackManipulation.isValid()).thenReturn(true);
        MethodDelegationBinder.ParameterBinding<?> binding = FieldGetterHandle.Binder.INSTANCE.bind(annotationDescription,
                source,
                target,
                implementationTarget,
                assigner,
