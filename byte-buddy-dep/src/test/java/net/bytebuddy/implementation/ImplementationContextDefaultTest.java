...
public class ImplementationContextDefaultTest {
    ...
    public void setUp() throws Exception {
        ...
        when(methodPool.target(any(MethodDescription.class), true)).thenReturn(record);
