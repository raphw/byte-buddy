...
public class ModifierReviewableTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                ...
                {Opcodes.ACC_TRANSIENT, "getFieldManifestation", FieldManifestation.TRANSIENT},
                {Opcodes.ACC_VOLATILE, "getFieldManifestation", FieldManifestation.VOLATILE},
                {Opcodes.ACC_VOLATILE | Opcodes.ACC_TRANSIENT, "getFieldManifestation", FieldManifestation.VOLATILE_TRANSIENT},
