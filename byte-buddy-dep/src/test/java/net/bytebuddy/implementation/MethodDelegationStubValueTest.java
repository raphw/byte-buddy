...
public class MethodDelegationStubValueTest extends AbstractImplementationTest {
    ...
    public void testVoidMethod() throws Exception {
        ...
        VoidMethod instance = loaded.getLoaded().newInstance();
        instance.foo();
    }
    ...
    public void testReference() throws Exception {
        ...
        ReferenceMethod instance = loaded.getLoaded().newInstance();
    ...
    public void testLongValue() throws Exception {
        ...
        LongMethod instance = loaded.getLoaded().newInstance();
    ...
    public void tesIntegerValue() throws Exception {
        ...
        IntegerMethod instance = loaded.getLoaded().newInstance();
