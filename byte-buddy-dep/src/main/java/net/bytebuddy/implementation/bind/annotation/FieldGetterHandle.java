 ...
 * </p>
 * <p>
 * Setting {@link FieldGetterHandle#value()} is optional. If the value is not set, the field value attempts to bind a setter's
 ...
 * </p>
 * <p>
 * <b>Important</b>: Don't confuse this annotation with {@link net.bytebuddy.asm.Advice.FieldGetterHandle} annotation. This annotation
...
public @interface FieldGetterHandle {
    ...
    /**
     * Binds a {@link FieldGetterHandle} annotation.
     */
    enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<FieldGetterHandle> {
        ...
        /**
         * Creates a new binder for a {@link FieldGetterHandle}.
         *
         * @param delegate A delegate parameter binder responsible for binding the parameter.
         */
        Binder(TargetMethodAnnotationDrivenBinder.ParameterBinder<FieldGetterHandle> delegate) {
         ...
         * {@inheritDoc}
         */
        public MethodDelegationBinder.ParameterBinding<?> bind(AnnotationDescription.Loadable<FieldGetterHandle> annotation,
        ...
        /**
         * A delegate implementation for the {@link FieldGetterHandle.Binder}.
         */
        protected static class Delegate extends ForFieldBinding<FieldGetterHandle> {
            ...
            protected MethodDelegationBinder.ParameterBinding<?> bind(FieldDescription fieldDescription,
                ...
                if (!target.getType().asErasure().isAssignableFrom(JavaType.METHOD_HANDLE.getTypeStub())) {
                    ...
                    return new MethodDelegationBinder.ParameterBinding.Anonymous(JavaConstant.MethodHandle.ofGetter(fieldDescription.asDefined()).toStackManipulation());
                } else {
                    return new MethodDelegationBinder.ParameterBinding.Anonymous(new StackManipulation.Compound(
                            JavaConstant.MethodHandle.ofGetter(fieldDescription.asDefined()).toStackManipulation(),
