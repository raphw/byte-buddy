        ...
        protected enum LambdaInstrumentationStrategy {
            ...
            protected static class MetaFactoryRedirection implements AsmVisitorWrapper.ForDeclaredMethods.MethodVisitorWrapper {
                ...
                public MethodVisitor wrap(TypeDescription instrumentedType, MethodDescription.InDefinedShape methodDescription, MethodVisitor methodVisitor) {
                    ...
                    Label firstBranch = new Label();
                    methodVisitor.visitJumpInsn(Opcodes.IFNE, firstBranch);
                    ...
                    Label secondBranch = new Label();
                    methodVisitor.visitJumpInsn(Opcodes.GOTO, secondBranch);
                    methodVisitor.visitLabel(firstBranch);
                    ...
                    methodVisitor.visitMethodInsn(Opcodes.INVOKESPECIAL, "java/lang/invoke/ConstantCallSite", "<init>", "(Ljava/lang/invoke/MethodHandle;)V", false);
                    methodVisitor.visitLabel(secondBranch);
            ...
            protected static class AlternativeMetaFactoryRedirection implements AsmVisitorWrapper.ForDeclaredMethods.MethodVisitorWrapper {
                ...
                public MethodVisitor wrap(TypeDescription instrumentedType, MethodDescription.InDefinedShape methodDescription, MethodVisitor methodVisitor) {
                    ...
                    methodVisitor.visitJumpInsn(Opcodes.IFEQ, conditional);
                    methodVisitor.visitVarInsn(Opcodes.ALOAD, 3);
                    methodVisitor.visitInsn(Opcodes.ICONST_4);
                    methodVisitor.visitInsn(Opcodes.AALOAD);
                    methodVisitor.visitTypeInsn(Opcodes.CHECKCAST, "java/lang/Integer");
                    ...
                    Label conditionalBranch = new Label();
                    methodVisitor.visitJumpInsn(Opcodes.GOTO, conditionalBranch);
                    methodVisitor.visitLabel(conditional);
                    methodVisitor.visitFrame(Opcodes.F_APPEND, 1, new Object[]{Opcodes.INTEGER}, 0, null);
                    methodVisitor.visitInsn(Opcodes.ICONST_0);
                    methodVisitor.visitTypeInsn(Opcodes.ANEWARRAY, "java/lang/Class");
                    methodVisitor.visitVarInsn(Opcodes.ASTORE, 5);
                    methodVisitor.visitLabel(conditionalBranch);
                    ...
                    methodVisitor.visitJumpInsn(Opcodes.IFEQ, loopCondition);
                    methodVisitor.visitInsn(Opcodes.ICONST_1);
                    Label loopStatement = new Label();
                    methodVisitor.visitJumpInsn(Opcodes.GOTO, loopStatement);
                    methodVisitor.visitLabel(loopCondition);
                    methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[]{"java/lang/invoke/MethodHandles$Lookup", "java/lang/String", "java/lang/invoke/MethodType", "[Ljava/lang/Object;", Opcodes.INTEGER, "[Ljava/lang/Class;", "sun/misc/Unsafe"}, 7, new Object[]{"sun/misc/Unsafe", "java/lang/Class", "java/lang/reflect/Method", Opcodes.NULL, "[Ljava/lang/Object;", "[Ljava/lang/Object;", Opcodes.INTEGER});
                    methodVisitor.visitInsn(Opcodes.ICONST_0);
                    methodVisitor.visitLabel(loopStatement);
                    methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[]{"java/lang/invoke/MethodHandles$Lookup", "java/lang/String", "java/lang/invoke/MethodType", "[Ljava/lang/Object;", Opcodes.INTEGER, "[Ljava/lang/Class;", "sun/misc/Unsafe"}, 8, new Object[]{"sun/misc/Unsafe", "java/lang/Class", "java/lang/reflect/Method", Opcodes.NULL, "[Ljava/lang/Object;", "[Ljava/lang/Object;", Opcodes.INTEGER, Opcodes.INTEGER});
                    methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, "java/lang/Boolean", "valueOf", "(Z)Ljava/lang/Boolean;", false);
                    methodVisitor.visitInsn(Opcodes.AASTORE);
                    methodVisitor.visitInsn(Opcodes.DUP);
                    methodVisitor.visitIntInsn(Opcodes.BIPUSH, 7);
